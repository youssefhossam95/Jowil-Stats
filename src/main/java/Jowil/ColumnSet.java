...
public class ColumnSet extends HBox {
    ...
    ColumnSet(String name,String color,int startIndex,int mySize,ManualModeController parentController,String type){
        ...
        nameTextField.setStyle("-jfx-focus-color:#07446b;-jfx-unfocus-color: #989898");
        ...
        typeTextField.setStyle("-jfx-focus-color:#07446b;-jfx-unfocus-color: #989898");
        ...
        rightArrowIcon.setStyle("-fx-fill:#07446b");
