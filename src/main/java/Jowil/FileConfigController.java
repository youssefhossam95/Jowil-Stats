...
public class FileConfigController extends Controller {
    ...
    FileConfigController() {
        ...
        super("FileConfig.fxml", "File configuration", 1.6, 1.45, true, null,"colored1.png",0,"Files Configuration");
...
//
    ...
    private void initManualModeToggle() {
        manualModeToggle.setStyle("-jfx-untoggle-color:#084d78;-jfx-toggle-color:#084d78");
